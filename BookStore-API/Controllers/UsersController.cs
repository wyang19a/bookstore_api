...
namespace BookStore_API.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        /// <returns></returns>
        [Route("login")]
        [AllowAnonymous] // Does not need to be authorization. `restricted by role`, `authorized`
                         // same is the case even if the entire class is set to [Authorized]
        [HttpPost]
        ...
        private async Task<string> GenerateJSONWebToken(IdentityUser user)
        {
            ...
            {
                new Claim(JwtRegisteredClaimNames.Sub, user.Email), // .Sub will house user.Email
